...
//	protected CloseableHttpResponse response = null;
	...
	//HttpDelete 方法
	public Object doSendDelete(String url, Map<String,String>mapParams,Map<String,String> headerParams) {
		 
		String deleteURL=url+"?"+getPostParameter(mapParams);
	...
	//拼接Authorization字符串
		...
		public String getAuthorizationString(String filename) {
			...
			AuthorMap=getParameterFromFileAsMap(filename);
