...
public class MailTest {
	...
	public static void main(String [] args){
		...
		mail.doSendHtmlEmail("测试邮件", "测试邮件内容", "yaojing@yongche.com"	, null);
		mail.doSendSMS("13910147603", "testsms form yaojing");
	...
	public MailTest(boolean debug) {
        ...
        properties.put("mail.sender.username", "yaojing@yongche.com");
        properties.put("mail.sender.password","tf58228888");	   
